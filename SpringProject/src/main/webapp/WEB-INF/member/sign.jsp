...
<div class="login-form">
    ...
    <form action="/cpzLoginPro" method="post">
        <div class="form-group">
            <label for="username">Username:</label>
            <input type="text" id="emp_id" name="emp_id" placeholder="Username" required>
        </div>
        <div class="form-group">
            <label for="password">Password:</label>
            <input type="password" id="emp_pw" name="emp_pw" placeholder="Password" required>
        </div>
        <div class="form-group">
